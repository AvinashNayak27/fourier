...
\author{M Avinash\\ \normalsize AI21BTECH11018 \\ \vspace*{20pt} \normalsize \today}
 ...
 \begin{abstract}
    ...
    \solution 
    \begin{lstlisting}
wget https://github.com/AvinashNayak27/fourier/blob/master/Fourier/codes/1.1.py
    \end{lstlisting}
    \begin{figure}[!ht]
			\centering
...
\end{cases}
    ...
    \item Verify 
        ...
        \solution 
        \begin{lstlisting}
wget https://github.com/AvinashNayak27/fourier/blob/master/Fourier/codes/2.3.py
        python3 2.3.py
        \end{lstlisting}
          \begin{figure}[!ht]
			\centering
...
b_k&=j\brak{c_k-c_{-k}}=0
    ...
    using python.\\
     \solution 
        \begin{lstlisting}
wget https://github.com/AvinashNayak27/fourier/blob/master/Fourier/codes/2.6.py
        python3 2.3.py
        \end{lstlisting}
          \begin{figure}[!ht]
			\centering
...
%	\end{align}
 ...
 x(t)&\system{F}\sum_{k=-\infty}^{\infty} \delta\brak{f+kf_0} c_k\\
	...
	\begin{lstlisting}
wget https://github.com/AvinashNayak27/fourier/blob/master/Fourier/codes/3.8.py
	\end{lstlisting} 
%	
	\item Show that
	\begin{align}
...
Applying fourier transform we get,
	...
	\label{fig:3.9}
\end{figure}
The below python code plots the figure
	\begin{lstlisting}
	wget https://github.com/AvinashNayak27/fourier/blob/master/Fourier/codes/3.9.py
\end{lstlisting} 
...
\end{figure}
	...
	The below python code plots the figure
	\begin{lstlisting}
wget https://github.com/AvinashNayak27/fourier/blob/master/Fourier/codes/3.10.py
	\end{lstlisting} 
...
Hence verified.
	\begin{figure}[!ht]
			...
			\label{eq:fig:4.3}
		\end{figure}
The following python code plots the figure
\begin{lstlisting}
wget https://github.com/AvinashNayak27/fourier/blob/master/Fourier/codes/4.3.py
\end{lstlisting} 
\end{enumerate}
\pagebreak
...
\begin{enumerate}[label=\thesection.\arabic*
	...
	\end{align}
	The L-C network is shown in Fig.
	\begin{figure}[!ht]
		\centering
		\begin{circuitikz} 
	...
	\end{figure}
	Below python code plots the figure
	\begin{lstlisting}
wget https://github.com/AvinashNayak27/fourier/blob/master/Fourier/codes/5.3.py
	\end{lstlisting} 
...
\end{figure}
	Below python code plots the figure 
	\begin{lstlisting}
wget https://github.com/AvinashNayak27/fourier/blob/master/Fourier/codes/5.4.py
	\end{lstlisting} 
\end{enumerate}
